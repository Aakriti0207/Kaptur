export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-espresso-canvas px-4">
      <div className="text-center max-w-sm w-full">
        <h1 className="font-serif text-4xl font-semibold text-caramel mb-2">kaptur</h1>
        <p className="text-sm text-espresso-textSecondary mb-10">Your job search, in one place.</p>
        <div className="bg-espresso-card border border-espresso-border rounded-card p-6">
          <button
              onClick={handleLogin}
              className="w-full flex items-center justify-center gap-2 bg-espresso-canvas border border-espresso-border text-espresso-textPrimary px-6 py-3 rounded-lg text-sm font-medium hover:border-caramel transition-colors"
          >
